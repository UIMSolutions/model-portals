  ...
  override void initialize() {
    ...
    this
      ...
      .addValues([ // individual values
        ...
        "SLAId": UUIDAttributeClass, // Choose the service level agreement (SLA) that you want to apply to the case record. 
        ...
        "productSerialNumber": NumberAttributeClass, //Type the serial number of the product that is associated with this case, so that the number of cases per product can be reported. 
        ...
        "ticketNumber": NumberAttributeClass, //Shows the case number for customer reference and searching capabilities. This cannot be modified. 
        ...
        "accountId": UUIDAttributeClass, // Unique identifier of the account with which the case is associated. 
        ...
        "transactionCurrencyId": UUIDAttributeClass, // Choose the local currency for the record to make sure budgets are reported in the correct currency. 
