  ...
  override void initialize() {
    ...
    this
      .addValues([
        ...
        "submittedOn": TimestampAttributeClass, // Shows the date and time this idea was submitted."]), 
        "ideaForumId": UUIDAttributeClass, // The parent idea forum that this idea belongs to."]), 
        "partialUrl": UrlAttributeClass, // Shows the URL path fragment used to generate a URL for this idea."]), 
        ...
        "totalVotesDate": DateAttributeClass, // Last Updated time of rollup field Total Votes."]), 
        ...
        "votesSumDate": DateAttributeClass, // Last Updated time of rollup field Vote Sum."]), 
