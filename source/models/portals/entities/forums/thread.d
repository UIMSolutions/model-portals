...
// 
class DPortalForumThread : DOOPEntity {
  mixin(OOPEntityThis!("PortalForumThread"));
...
mixin(OOPEntityCalls!("PortalForumThread"));

version(test_model_portals) {
  unittest {
    assert(PortalForumThread);
  
  auto entity = PortalForumThread;
